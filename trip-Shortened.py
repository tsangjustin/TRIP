...
def findLongestTrip(line1, line2, memo):
    ...
    # If there is matching city
        ...
        lst = [1 + lose12[0], set([line1[0] + subStr for subStr in lose12[1] if len(subStr) == lose12[0]])]
    ...
    # Check all variation if city does not match
        ...
        maxLen = max(lose1[0], lose2[0])
        lst = [maxLen, set([subStr for subStr in lose12 if len(subStr) == maxLen])]
        memo[(line1, line2)] = lst
        return lst
